# Hey ya'll. Try this lab challenges out
...
├── 0xluwa.json             # Database file (auto-generated)
│
├── routes/
...
- **File**: `0xluwa.json` (auto-created)
- **Location**: Project root directory

To reset the database, simply delete `0xluwa.json` and restart the server.
...
**Problem**: Corrupted `0xluwa.json`

**Solution**:
```bash
# Delete the database file
rm 0xluwa.json  # Linux/Mac
del 0xluwa.json  # Windows
